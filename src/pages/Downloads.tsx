    ...
    <div className="space-y-8">
      <div className="text-center max-w-2xl mx-auto space-y-4">
        ...
        <p className="text-xl opacity-80">
          Customisez votre bureau et votre vie avec nos packs exclusifs. 100% gratuit, 100% Y2K.
        </p>
      </div>
          ...
          return (
            <Y2KWindow key={item.id} title={`${item.category.toUpperCase()}`}>
              <div className="flex flex-col items-center text-center space-y-4 p-2">
                <div className={cn("p-4 bg-y2k-border rounded-full", CategoryColor[item.category])}>
                  <Icon size={40} />
                </div>
                <div>
                ...
                <a href={item.url} className="y2k-button w-full">Download</a>
              </div>
            </Y2KWindow>
          );
        })}
        ...
        <Y2KWindow title="COMING SOON" className="opacity-50 grayscale">
          <div className="flex flex-col items-center text-center space-y-4 p-2">
            ...
            <div>
              ...
              <p className="text-sm opacity-40 mt-1">En cours de compression...</p>
            </div>
            <button disabled className="y2k-button w-full opacity-50 cursor-not-allowed">Locked</button>
          </div>
        </Y2KWindow>
      </div>
      ...
      <Y2KWindow title="WINAMP PLAYER" className="max-w-md mx-auto">
        <div className="bg-[#1a1a1e] p-4 border-2 border-[#333338] space-y-4">
          ...
          <div className="flex gap-2 justify-center">
            <button className="w-8 h-8 bg-y2k-border border border-white/20 text-[10px]">PREV</button>
            <button className="w-8 h-8 bg-y2k-border border border-white/20 text-[10px]">PLAY</button>
            <button className="w-8 h-8 bg-y2k-border border border-white/20 text-[10px]">STOP</button>
            <button className="w-8 h-8 bg-y2k-border border border-white/20 text-[10px]">NEXT</button>
          </div>
