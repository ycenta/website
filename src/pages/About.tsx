  ...
  if (showUnderConstruction) {
    return (
      <UnderConstructionPage
        title="À PROPOS DE LUDOKINO"
        subtitle="La page de présentation reste volontairement sous bâche pour le moment. On préfère garder les révélations pour plus tard."
        windowTitle="ABOUT_LOCKED.SYS"
      />
    );
  }
    ...
    <div className="max-w-5xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Y2KWindow title="L_ASSOCIATION.DOC">
          <div className="space-y-4">
            ...
            <p className="leading-relaxed">
              Nous croyons en un média indépendant, financé par sa communauté et
              ses partenaires, sans compromis sur la qualité éditoriale.
            </p>
          </div>
        </Y2KWindow>
          ...
          <div className="space-y-6 text-center py-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm opacity-60">
                Logos, photos de l'équipe et fiches techniques.
              </p>
            </div>
      ...
      <Y2KWindow title="THE TEAM">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 p-4">
          {TEAM.map((member) => (
            <div
              key={member.name}
              className="flex gap-4 border border-y2k-border p-4 bg-black/20"
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-y2k-cyan font-mono uppercase">
                  {member.role}
                </p>
      ...
      <div className="text-center space-y-6 py-12">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button className="y2k-button border-y2k-magenta text-y2k-magenta">
            Faire un don
          </button>
        </div>
      </div>
